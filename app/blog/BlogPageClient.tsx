        ...
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center", maxWidth: 580 }}>
            ...
            <button onClick={() => setDrawerOpen(true)}
              style={{ display: "flex", alignItems: "center", gap: 7, padding: "13px 18px", borderRadius: 14, border: "none", cursor: "pointer", fontWeight: 700, fontSize: 13, background: activeCount > 0 ? "#0d9488" : "#fff", color: activeCount > 0 ? "#fff" : "#374151", boxShadow: "0 4px 20px rgba(0,0,0,0.15)", transition: "all 0.15s", whiteSpace: "nowrap" as const, flexShrink: 0 }}>
